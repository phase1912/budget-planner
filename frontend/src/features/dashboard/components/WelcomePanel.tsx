...
/**
 * What `/` shows before the first receipt: a greeting and the way to upload one
 * (docs/design/screens/home.html). Replaced by the month view once any receipt exists.
 */
