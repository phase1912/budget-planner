...
export const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={`bg-surface border-b border-border px-4.5 py-3.5 text-xl font-semibold ${className ?? ""}`} {...props} />
  )
);
...
export const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={`bg-surface border-t border-border px-5 py-3.25 text-md ${className ?? ""}`} {...props} />
  )
);
